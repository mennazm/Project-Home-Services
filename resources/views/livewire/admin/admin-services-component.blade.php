                                    ...
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a href="#" onclick="confirm('Are you sure,you want to delete service category!')||event.stopImmediatePropagation()" wire:click.prevent="deleteService({{$service->id}})" style="margin-left:40px"> <i class="fa fa-times fa-2x text-danger"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
