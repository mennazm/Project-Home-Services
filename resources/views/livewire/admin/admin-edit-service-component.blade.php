                            ...
                            <div class="panel panel-defult">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            <label for="tag line" class="control-label col-md-3" > Tagline:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="id" class="control-label col-md-3" >Service Category:</label>
                                            <div class="col-sm-9">
                                               <select class="form-control" wire:model="service_category_id">
                                                ...
                                                @error('servicecategory') <p class="text-danger">{{$message}}</p> @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="Discount" class="control-label col-md-3" >DiscountType:</label>
                                            <div class="col-sm-9">
                                         ...
                                         <div class="form-group">
                                            <label for="Discount" class="control-label col-md-3" >Featured:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="description" class="control-label col-md-3" >inclusion:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="exclusion" class="control-label col-md-3" >Exclusion:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="imge" class="control-label col-md-3" > Thumbnail:</label>
                                            <div class="col-sm-9">
