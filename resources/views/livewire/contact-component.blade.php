                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <aside>
                                    <h4>The Office</h4>
                                    <address>
                                        <strong>CompanyName Home Services.</strong><br>
                                        <i class="fa fa-map-marker"></i><strong>Address: </strong>Talkha, Mansoura<br>
                                        <i class="fa fa-phone"></i><strong>Phone: </strong> +201013285085
                                    </address>
                                    <address>
                                        <strong>CompanyName Emails</strong><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:hodatarek@std.mans.edu.eg"> hodatarek@std.mans.edu.eg</a><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:hodatarek@std.mans.edu.eg"> hodatarek@std.mans.edu.eg</a>
                                    </address>
                                </aside>
                                <hr class="tall">
                            </div>
